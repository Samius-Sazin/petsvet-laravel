...
<footer class="bg-primary text-dark py-5">
    <div class="container">
        <div class="row gy-4 gx-lg-5">
            ...
            <!-- 1st Part: Logo & Description & Social Links -->
            <div class="col-lg-7">
                ...
                <div class="d-flex gap-3 mt-3">
                    ...
                    <a href="#" class="text-dark fs-3"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-5 d-flex justify-content-lg-between flex-wrap">
                    ...
                    <ul class="list-unstyled mt-2">
                        <li class="mb-2">
                            <a href="/consultancy" class="text-dark d-flex align-items-center text-decoration-none">
                                <i class="fas fa-comments me-2"></i> Consultancy
                            </a>
                        </li>
                        <li class="mb-2">
                        ...
                        <li class="mb-2">
                            <a href="/qna" class="text-dark d-flex align-items-center text-decoration-none">
                ...
                <!-- Contact Info -->
                <div class="mb-3">
                    <h5 class="text-decoration-underline fs-4">Contact Info</h5>
                    <ul class="list-unstyled mt-2">
